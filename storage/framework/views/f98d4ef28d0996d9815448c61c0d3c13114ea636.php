  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url('parent')); ?>">Parent</a>
        </li>
        <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url('optedcourse')); ?>">Opted Course</a>
...
</nav><?php /**PATH C:\Users\fahmi\OneDrive\Desktop\laravelapp\app\resources\views/layouts/inc/navbar.blade.php ENDPATH**/ ?>